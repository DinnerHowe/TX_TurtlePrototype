...
(cl:defmethod cl:initialize-instance :after ((m <user_IDs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'user_IDs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name skeleton_detection-msg:<user_IDs> is deprecated: use skeleton_detection-msg:user_IDs instead.")))

(cl:ensure-generic-function 'users-val :lambda-list '(m))
(cl:defmethod users-val ((m <user_IDs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader skeleton_detection-msg:users-val is deprecated.  Use skeleton_detection-msg:users instead.")
  (users m))
